...
export const Chart = () => {
  ...
  <div id="main-wrapper">
              ...
              <div className="card-header chat-list-header text-center">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end">
                    ...
                    <li className="dropdown-item"><i className="fa fa-users text-primary me-2" /> Add to btn-close _______ </li>
              ...
              <div className="card-body msg_card_body dlab-scroll" id="DLAB_W_Contacts_Body3">
                <div className="d-flex justify-content-start mb-4">
                  ...
                  <div className="msg_cotainer">
                    Hi, how are you _____?
                    <span className="msg_time">8:40 AM, Today </span>
                  </div>
                </div>
                <div className="d-flex justify-content-end mb-4">
                  <div className="msg_cotainer_send">
                    Hi Khalid i am ____ tnx how about you?
                ...
                <div className="d-flex justify-content-start mb-4">
                  ...
                  <div className="msg_cotainer">
                    I am good too, _____ you for your chat ________
                ...
                <div className="d-flex justify-content-start mb-4">
                  ...
                  <div className="msg_cotainer">
                    I am looking for ____ next templates
                    <span className="msg_time">9:07 AM, Today </span>
                  </div>
                </div>
                <div className="d-flex justify-content-end mb-4">
                  <div className="msg_cotainer_send">
                    Ok, thank you have _ good day
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      ...
                      <div className="user_info">
                        ...
                        <p>Jame Smith commented on ____ status </p>
                      </div>
                    </div>
                  </li>
                  <li className="name-first-letter">SEVER STATUS </li>
              ...
              <div className="card-body contacts_body p-0 dlab-scroll" id="DLAB_W_Contacts_Body2">
                <ul className="contacts">
                  ...
                  <li>
                    <div className="d-flex bd-highlight">
                      <div className="user_info">
                        <span>john just buy your _______.. </span>
                        <p>10 Aug 2020 </p>
                      </div>
                      <div className="ms-auto">
                        <a href="javascript:void(0);" className="btn btn-primary btn-xs sharp me-1"><i className="fas fa-pencil-alt" /></a>
                      ...
                      <li>
                        <div className="timeline-panel">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1">Dr sultads Send you _____ </h6>
                    ...
                    <ul className="timeline">
                      <li>
                        ...
                        <a className="timeline-panel text-muted" href="javascript:void(0);">
                          ...
                          <h6 className="mb-0">Youtube, a video-sharing website, ____ live  <strong className="text-primary">$500 </strong>. </h6>
                        </a>
                      </li>
                      <li>
                        ...
                        <a className="timeline-panel text-muted" href="javascript:void(0);">
                          ...
                          <p className="mb-0">Quisque a consequat ante ___ amet magna at volutapt... </p>
                        </a>
                      </li>
                      <li>
                        ...
                        <a className="timeline-panel text-muted" href="javascript:void(0);">
                          ...
                          <h6 className="mb-0">john just buy your _______  <strong className="text-warning">Sell $250 </strong></h6>
                        </a>
                      </li>
                      <li>
                        ...
                        <a className="timeline-panel text-muted" href="javascript:void(0);">
                          ...
                          <h6 className="mb-0">StumbleUpon is acquired by ____.</h6>
                        </a>
                      </li>
                      <li>
                        ...
                        <a className="timeline-panel text-muted" href="javascript:void(0);">
                          <span>20 minutes ago </span>
                          <h6 className="mb-0">Mashable, a news website ___ blog, goes live. </h6>
                        </a>
                      </li>
                      <li>
              ...
              <li className="nav-item dropdown header-profile">
                <a className="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                  ...
                  <div className="header-info ms-3">
                    ...
                    <small className="fs-12 font-w400"><span className="__cf_email__" data-cfemail="3357565e5c73545e525a5f1d505c5e">[email&nbsp;protected] </span></small>
                  </div>
                </a>
                <div className="dropdown-menu dropdown-menu-end">
      ...
      <div className="dlabnav-scroll">
        ...
        <div className="plus-box">
          <div className="text-center">
            <h4 className="fs-18 font-w600 mb-4">Enable Workload Automation System </h4>
            <a href="javascript:void(0);" className="btn btn-primary btn-rounded">Learn more  <i className="fas fa-caret-right" /></a>
          </div>
        </div>
        <div className="copyright">
          <p><strong>Workload Project Management </strong> © 2021 All ______ Reserved </p>
      ...
      <div className="container-fluid">
        <div className="row page-titles">
          <ol className="breadcrumb">
            <li className="breadcrumb-item active"><a href="javascript:void(0)">Charts </a></li>
            <li className="breadcrumb-item"><a href="javascript:void(0)">Flot </a></li>
          </ol>
        </div>
        <div className="row">
              ...
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotBar1" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotBar2" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotLine1" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotLine2" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotLine3" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotArea1" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotArea2" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotRealtime1" className="flot-chart" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div id="flotRealtime2" className="flot-chart" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="footer">
      <div className="copyright">
        <p>Copyright © Designed &amp; _________ by  <a href="https://dexignlab.com/" target="_blank">DexignLab </a> 2021 </p>
      </div>
    </div>
  </div>
</div>
